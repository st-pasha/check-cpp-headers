...
std_symbols_library: dict[str, list[str]] = {
    ...
    "std::is_corresponding_member": ["type_traits"],
    ...
    "std::is_layout_compatible_v": ["type_traits"],
    ...
    "std::is_pointer_interconvertible_base_of_v": ["type_traits"],
    "std::is_pointer_interconvertible_with_class": ["type_traits"],
    ...
    "std::is_scoped_enum_v": ["type_traits"],
    ...
    "std::nanl": ["cmath"],
    "std::nearbyint": ["cmath"],
    "std::nearbyintf": ["cmath"],
    "std::nearbyintl": ["cmath"],
    ...
    "std::reference_constructs_from_temporary": ["type_traits"],
    "std::reference_constructs_from_temporary_v": ["type_traits"],
    "std::reference_converts_from_temporary": ["type_traits"],
    "std::reference_converts_from_temporary_v": ["type_traits"],
    "std::regex": ["regex"],
    "std::regex_error": ["regex"],
    "std::regex_match": ["regex"],
    "std::reinterpret_pointer_cast": ["memory"],
    "std::remainder": ["cmath"],
    "std::remainderf": ["cmath"],
    "std::remainderl": ["cmath"],
    ...
    "std::unwrap_reference": ["type_traits", "functional"],
    "std::unwrap_reference_t": ["type_traits", "functional"],
    "std::unwrap_ref_decay": ["type_traits", "functional"],
    "std::unwrap_ref_decay_t": ["type_traits", "functional"],
